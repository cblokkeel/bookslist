...
const Header = ({ toggleDark }) => {
    ...
    return (
        <header className='h-32 flex items-center justify-between p-12 dark:text-white'>
            ...
            <svg ref={moon} onClick={darkMode} className='w-8 md:w-12 moon cursor-pointer' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" />
            </svg>
            <svg ref={sun} onClick={darkMode} className='hidden w-8 md:w-12 sun cursor-pointer' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
